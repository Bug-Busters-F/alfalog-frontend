...
const CardAscDec = () => {
    ...
    // Séries para o gráfico de ascensão
    ...
    // Séries para o gráfico de declínio
    ...
    // Função para alternar entre mostrar gráfico de ascensão ou declínio
    const mostrarGraficoAscensao = () => setMostrarGrafico("ascensao");
    const mostrarGraficoDeclinio = () => setMostrarGrafico("declinio");

    // Definir qual série mostrar baseado no estado `mostrarGrafico`
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-0 my-5">
            ...
            <div className="col-start-1 col-end-1 block max-w-sm shadow-md bg-gray-200 border-b border-sky-700 rounded-lg">
                ...
                <div className="px-6 py-4 font-medium text-lg text-gray-900">
                    <p><b className="text-green-600">Rank 1:</b> São Paulo (SP)
                        <span className="text-sm ml-2 px-2 py-0.5 rounded-full bg-green-700 text-green-200">69%</span>
                    </p>
                    <p><b className="text-green-600">Rank 2:</b> São Paulo (SP)
                        <span className="text-sm ml-2 px-2 py-0.5 rounded-full bg-green-700 text-green-200">69%</span>
                    </p>
                    <p><b className="text-green-600">Rank 3:</b> São Paulo (SP)
                        <span className="text-sm ml-2 px-2 py-0.5 rounded-full bg-green-700 text-green-200">69%</span>
                    </p>
                    <p><b className="text-green-600">Rank 4:</b> São Paulo (SP)
                        <span className="text-sm ml-2 px-2 py-0.5 rounded-full bg-green-700 text-green-200">69%</span>
                    </p>
                    <p><b className="text-green-600">Rank 5:</b> São Paulo (SP)
                        <span className="text-sm ml-2 px-2 py-0.5 rounded-full bg-green-700 text-green-200">69%</span>
                    </p>
                </div>
            ...
            <div className="col-start-1 col-end-1 md:col-start-2 md:col-end-2 block max-w-sm shadow-md bg-gray-200 border-b border-sky-700 rounded-lg">
                ...
                <div className="px-6 py-4 font-medium text-lg text-gray-900">
                    <p><b className="text-red-600">Rank 1:</b> São Paulo (SP)
                        <span className="text-sm ml-2 px-2 py-0.5 rounded-full bg-red-700 text-red-200">69%</span>
                    </p>
                    <p><b className="text-red-600">Rank 2:</b> São Paulo (SP)
                        <span className="text-sm ml-2 px-2 py-0.5 rounded-full bg-red-700 text-red-200">69%</span>
                    </p>
                    <p><b className="text-red-600">Rank 3:</b> São Paulo (SP)
                        <span className="text-sm ml-2 px-2 py-0.5 rounded-full bg-red-700 text-red-200">69%</span>
                    </p>
                    <p><b className="text-red-600">Rank 4:</b> São Paulo (SP)
                        <span className="text-sm ml-2 px-2 py-0.5 rounded-full bg-red-700 text-red-200">69%</span>
                    </p>
                    <p><b className="text-red-600">Rank 5:</b> São Paulo (SP)
                        <span className="text-sm ml-2 px-2 py-0.5 rounded-full bg-red-700 text-red-200">69%</span>
                    </p>
                </div>
                <div className="border-t-1 px-6 py-3 border-gray-300">
            ...
            {/* Renderizando o gráfico com base no botão pressionado */}
            {mostrarGrafico && (
